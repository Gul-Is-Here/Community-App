...
PrayerTimingsModel prayerTimesModelFromJson(String str) =>
    PrayerTimingsModel.fromJson(json.decode(str));

String prayerTimesModelToJson(PrayerTimingsModel data) =>
...
class Data {
  ...
  List<PrayerTimingsUpcoming>? prayerTimingsUpcomings;
  PrayerTimes? prayerTimings;

  Data({
    this.iqamahTimings,
    this.prayerTimingsUpcomings,
    this.prayerTimings,
  });
  ...
  Map<String, dynamic> toJson() => {
        ...
        "PrayerTimingsUpcoming": prayerTimingsUpcomings == null
            ? []
            : List<dynamic>.from(
                prayerTimingsUpcomings!.map((x) => x.toJson())),
        "PrayerTime": prayerTimings?.toJson(),
      };
}
