...
//     var familyMemberController = Get.put(FamilyController());
...
//                                       // Use available class names from your classesList
//                                       items: familyMemberController.classesList
//                                           .map((classData) {
//                                         return DropdownMenuItem<String>(
//                                           value: classData[
//                                               'class_name'], // Assuming class_name is the field you want
//                                           child: Text(
//                                             classData[
//                                                 'class_name'], // Display the class name in dropdown
//                                             style: const TextStyle(
...
//                                             horizontal: 20),
//                                         child: Text(
//                                           'Select a Class', // Default hint text
//                                           style: TextStyle(
